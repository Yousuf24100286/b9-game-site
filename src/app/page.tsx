  ...
  return (
    <div className="flex flex-col items-center gap-8 max-w-screen-sm text-center mx-auto my-20">
      ...
      <div className="w-full">
        <H3 className="bg-red-100">B9 Bonus</H3>
      ...
      <div className="w-full">
        <H3 className="bg-red-100">B9 Tips And Tricks</H3>
      ...
      <div className="w-full">
        <H3 className="bg-red-100">B9 Game Features</H3>
        <ol className="">
          <li>
            <H5>3x3 Grid</H5>
      ...
      <div className="w-full">
        <H3 className="bg-red-100">Modes of B9 Game</H3>
      ...
      <div className="w-full">
        <H3 className="bg-red-100">Games varieties in B9</H3>
        <ol className="">
          <li>Teen Patti</li>
          <li>Ludo</li>
          <li>Joker</li>
      ...
      <div className="w-full" >
        <H3 className="bg-red-100">B9 Game Review</H3>
      ...
      <div className="w-full">
        <H3 className="bg-red-100">Conclusion</H3>
